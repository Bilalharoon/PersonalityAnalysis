...
# print('open this url and authorize the app nigga')
# print(auth_url)

# redirected_url = input('\n Paste that shit in here so we know the url is right')
...
def get_top_tracks_with_features(limit=20, time_range="medium_term"):
